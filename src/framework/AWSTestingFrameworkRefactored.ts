...
export class AWSTestingFrameworkRefactored {
  // AWS Service clients
  ...
  ): AWSTestingFrameworkRefactored {
    return new AWSTestingFrameworkRefactored(config);
  }

  /**
   * Create framework instance for development environment
   */
  static createForDevelopment(region?: string): AWSTestingFrameworkRefactored {
    return new AWSTestingFrameworkRefactored({
   ...
   */
  static createForProduction(region?: string): AWSTestingFrameworkRefactored {
    return new AWSTestingFrameworkRefactored({
      aws: { region: region || 'us-east-1' },
   ...
   */
  static createForCI(region?: string): AWSTestingFrameworkRefactored {
    return new AWSTestingFrameworkRefactored({
      aws: { region: region || 'us-east-1' },
